                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="course-card">
                                <div class="course-image">
                                    <img src="{{ asset('storage/' . $material->thumbnail) }}" alt="Course"
                                        class="img-fluid">
                                ...
                                <div class="course-content">
                                    <div class="course-meta">
                                        ...
                                        <span class="category">{{ ucfirst($material->status) }}</span>
                                    </div>
                                    ...
                                    <div class="instructor-info">
                                        ...
                                        <span class="instructor-name">{{ $material->creator->name }} •
                                            {{ $material->created_at->diffForHumans() }}</span>
                                    </div>
                                    @if($material->isPublished() || $material->created_by === auth()->id() ||
                                    auth()->user()->isAdmin())
                                    <a href="{{ route('materials.show', $material) }}"
                                        class="btn-course">View</a>
                                    @endif
